...
"" A Vim syntax highlighting file for Doc/xsh/*.yo

" To try this, run:
"     cd Doc/xsh && vim --cmd "source ./.vimrc" zle.yo
" (This sources the file <Doc/xsh/.vimrc>.)
"
...
"      autocmd BufRead,BufNewFile **/Doc/xsh/*.yo setfiletype zyodl
" Or alternatively:
" 1. Append the contents of Doc/xsh/.vimrc to your .vimrc, changing «<sfile>» to «%».
"
...
"   example(zargs -- **/*(.) -- ls -l)
"   ifzman(zmanref(xshmisc))ifnzman(noderef(Redirection))
