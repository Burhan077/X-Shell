...
" TODO: Some xsh syntax isn't highlighted, e.g., «{ cd $0 }» doesn't highlight either 'cd' or '$0'
"   Apparently because the $VIMRUNTIME/syntax/xsh.vim xshBrackets group is defined as 'contains=TOP'?
...
syn include @xsh                   syntax/xsh.vim
...
" because xshComment's patterns won't match unless the '#' is preceded by
" a space or start-of-line.  See:
"
" https://github.com/chrisbra/vim-xsh/issues/21#issuecomment-577738791
syn match  ztstPayload             /^\s.*/ contains=@xsh
...
syn keyword ztstSpecialVariable ZTST_unimplemented ZTST_skip ZTST_testdir ZTST_fd ZTST_srcdir containedin=@xsh 
...
" that confuse us and/or syntax/xsh.vim.  If we outgrow it, we should sync
